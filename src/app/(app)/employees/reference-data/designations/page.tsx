...
export default async function DesignationsPage({
  ...
  return (
    <div className="space-y-6">
      ...
      <form action={createDesignation} className="rounded-2xl border border-zinc-200 bg-white p-5">
                ...
                <tr key={d.id} className="hover:bg-zinc-50">
                  <td className="px-4 py-3">
                    ...
                    >
                      ...
                      />
                      <select
                        className="w-full max-w-xs rounded-lg border border-zinc-200 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-zinc-400"
                        name="department_id"
